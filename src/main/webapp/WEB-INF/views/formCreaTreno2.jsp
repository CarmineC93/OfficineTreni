...
<link rel="shortcut icon"
	href="file:///C:/Users/visco/eclipse-workspace/OfficineTreni/src/main/webapp/WEB-INF/images/logo.png"
	type="image/png">
...
<body>
	...
	<header>
		...
		<div id="logo">
			<img
				src="file:///C:/Users/visco/eclipse-workspace/OfficineTreni/src/main/webapp/WEB-INF/images/logoscritta.png"
				id="foto">
		</div>
			...
			<a href="" id="section">
				<form action="crea" method="get">
					<label for="sigla">sigla treno:</label><br> <input type="text"
						id="sigla" name="sigla" value=""><br> <input
