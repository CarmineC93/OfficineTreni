...
@Component
public class BuilderTrainImp implements TrenoBuilder {
...
//////CONSTRUCTORS
	 ...
	 * */
	@Override
	public TrenoBuilder aggiungiVagone(Vagone wagon) throws LocomotiveNotFoundException, MaxWeightReachedException, TrainAlreadyCompletedException, IncompatibleWagonTypologyException {
	...
	/*
	 * 	rimuove l'ultimo vagone di un determinato tipo dalla Collection trainComposition
	 * */
	@Override
	public TrenoBuilder removeLastWagonByType(char typology) throws LocomotiveNotFoundException, NothingToRemoveException, NotRemovableLocomotiveException, WagonsNotFoundException {
